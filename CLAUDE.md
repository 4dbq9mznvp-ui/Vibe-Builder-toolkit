...
## Conventions
- Before working, run `git fetch` (both Claude Code and Codex may push to this repo) and read docs/OPEN_CORE_BOUNDARY.md, docs/EXTERNAL_WORKFLOW.md, and CHANGELOG.md.
...
- Public/private boundary is documented in docs/OPEN_CORE_BOUNDARY.md; external work should follow docs/EXTERNAL_WORKFLOW.md.
