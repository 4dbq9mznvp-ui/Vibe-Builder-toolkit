...
- Switched install instructions to clone-based usage until the npm package is published.
...
- Added a first-party `ai-writing-humanizer` local transform that writes reviewable `output.md` and `changes.md` files without executing Stop Slop or any third-party code.
